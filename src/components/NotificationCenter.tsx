        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="absolute right-0 mt-3 w-80 md:w-96 rounded-2xl border border-nature-200 dark:border-nature-800 bg-white/95 dark:bg-nature-900/95 backdrop-blur-xl shadow-2xl z-50 overflow-hidden"
            >
              {/* Header */}
